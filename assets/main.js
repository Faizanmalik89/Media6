...
// adminTabs and adminTabContents are already declared in admin.js
...
function setupEventListeners() {
    ...
    // Admin tabs - using query selector since adminTabs is in admin.js
...
function showAdminTab(tabName) {
    // Hide all tab contents - using query selector since adminTabContents is in admin.js
    ...
    // Update tab highlights - using query selector since adminTabs is in admin.js
    document.querySelectorAll('.admin-sidebar li').forEach(tab => {
